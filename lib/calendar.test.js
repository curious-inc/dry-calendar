...
test("month movement", function(){
    ...
    var c = calendar({ start_date: "2016-02-01", end_date: "2016-02-05" });

    eq(c.start_date(), "2016-02-01");
    eq(c.end_date(), "2016-02-05");

    c.next_month();
    eq(c.start_date(), "2016-03-01");
    eq(c.end_date(), "2016-03-31");

    c.last_month();
    eq(c.start_date(), "2016-02-01");
    eq(c.end_date(), "2016-02-29");

    c.last_month();
    eq(c.start_date(), "2016-01-01");
    eq(c.end_date(), "2016-01-31");
...
test("weeks per month", function(){
    ...
    var first = { date: "2016-02-29", year: 2016, month: 1, day: 29, weekday: 0, label: "Mo" };
    var last = { date: "2016-04-10", year: 2016, month: 3, day: 10, weekday: 6, label: "Su" };

    var actual = [];

    c.days(function(d){ actual.push(d); });

    eq(_.first(actual), first);
    eq(_.last(actual), last);

});

test("weeks per month - sunday", function(){
    ...
    var first = { date: "2016-02-28", year: 2016, month: 1, day: 28, weekday: 0, label: "Su" };
    var last = { date: "2016-04-09", year: 2016, month: 3, day: 9, weekday: 6, label: "Sa" };
...
test("moved_days", function(){
    ...
    var c = calendar({ start_date: "2016-02-01", end_date: "2016-02-05", week_start: 2 });
...
test("first_day_of_month", function(){

    var c = calendar();

    eq("2016-02-01", _.iso_date(c._first_day_of_month(_.iso_date("2016-02-22"))));
    eq("2016-03-01", _.iso_date(c._first_day_of_month(_.iso_date("2016-03-22"))));
...
test("last_day_of_month", function(){
    ...
    eq("2016-02-29", _.iso_date(c._last_day_of_month(_.iso_date("2016-02-22"))));
    eq("2016-03-31", _.iso_date(c._last_day_of_month(_.iso_date("2016-03-22"))));
